...
class Cart {
  ...
  // 取得 Order_Temp 所有商品
    ...
    // `;
    const sql=`SELECT ot.Sid,ot.Order_Sid,ot.Product_id,ot.Order_Amount,pf.name,pf.price,pf.cate_sid FROM ${tableName} ot LEFT JOIN products_food pf ON ot.Product_id=pf.product_id`;
